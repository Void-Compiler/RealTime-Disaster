...
export default function DisasterHistory() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tighter md:text-3xl">Historical Disasters in Odisha</h2>
        <p className="mt-2 text-gray-500 dark:text-gray-400">
          A timeline of major disasters that have affected Odisha in the past
        </p>
      </div>
