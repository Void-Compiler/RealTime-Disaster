...
export default function DisasterEducationSection() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tighter text-teal-700 md:text-3xl">Disaster Education</h2>
      ...
      <Tabs defaultValue="flood" value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value={activeTab} className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-teal-700">{currentContent.title}</CardTitle>
            ...
            <CardContent>
              <Accordion type="single" collapsible defaultValue="before">
                <AccordionItem value="before">
                  <AccordionTrigger className="text-teal-700">
                    ...
                    <ul className="space-y-2">
                      {currentContent.beforeDisaster.map((item, index) => (
                        <li key={index} className="flex items-start">
                          <span className="mr-2 mt-1 flex h-2 w-2 rounded-full bg-teal-500"></span>
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <AccordionContent>
                    <ul className="space-y-2">
                      {currentContent.afterDisaster.map((item, index) => (
                        <li key={index} className="flex items-start">
                          <span className="mr-2 mt-1 flex h-2 w-2 rounded-full bg-blue-500"></span>
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
